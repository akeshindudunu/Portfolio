                    ...
                    <Card className="rounded-2xl shadow-md p-6">
                        ...
                        <CardContent className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                            ...
                            <div className="mt-6 space-y-3">
                                <p><strong>Email:</strong> <a href="mailto:akesh@example.com" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">akesh@example.com</a></p>
                                <p><strong>LinkedIn:</strong> <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">linkedin.com/in/akesh</a></p>
                                <p><strong>GitHub:</strong> <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">github.com/akesh</a></p>
                            </div>
